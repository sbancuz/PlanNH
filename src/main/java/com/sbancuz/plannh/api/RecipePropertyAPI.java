...
public class RecipePropertyAPI {
    ...
    public static final RecipeProperty<Long> EU_PER_TICK =
        RecipeProperty.longProperty("euPerTick", "EU/t", 0L);
    public static final RecipeProperty<float[]> OUTPUT_CHANCES =
        new RecipeProperty<>("outputChances", "Output Chances", new float[0],
            (obj, val) -> {
